...
main(int argc, char *argv[])
{
	...
	if ((pb_fd = open(PB, O_RDONLY)) != -1) {
		...
		if (thr_create(NULL, NULL, power_button_monitor, NULL,
		    THR_DAEMON, NULL) != 0) {
	...
	if (thr_create(NULL, NULL, system_activity_monitor, NULL,
	    THR_DAEMON, NULL) != 0) {
	...
	if (thr_create(NULL, NULL, autos3_monitor, NULL, THR_DAEMON,
	    NULL) != 0) {
